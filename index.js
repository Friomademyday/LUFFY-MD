...
async function startFrioBot() {
    ...
    if (!conn.authState.creds.registered) {
        ...
        setTimeout(async () => {
            try {
                const phoneNumber = "put your phone number here in format 44XXXXXXXXX"
...
const isCreator = ["44XXXXXXXXXX@s.whatsapp.net", "44XXXXXXXXXXX@s.whatsapp.net"].includes(sender) || m.key.fromMe
